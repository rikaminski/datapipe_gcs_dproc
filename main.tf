...
module "bucket-raw" {
  ...
  name       = "data-gcs_pipe-combustiveis-brasil-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "data-gcs_pipe-combustiveis-brasil-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "data-gcs_pipe-combustiveis-brasil-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "data-gcs_pipe-combustiveis-brasil-pyspark-code"
  project_id = var.project_id
  location   = var.region
}